...
export const Navbar = () => {
    ...
    const handleResume = () => {
        return window.open('https://drive.google.com/file/d/1dWuKW-Q3UbEV-viSc489WlMN2g6rT_Zg/view?usp=sharing');
    }
    return (
        <Box bg={bg} color={color} position={"sticky"} top="0" zIndex="10" borderBottom={"1px solid"} borderBottomColor={color}>
            ...
            <Box className='header-nav' >
                <Img width={"250px"} src={require('./res/other/logo-name.png')} />
                <nav ref={navRef} style={{ color: color }} >
                    ...
                    <a href="Karan-Tiwari-Resume.pdf" target={"_blank"} download className='hvr-underline-from-center'><Button color={color} onClick={handleResume}>Resume</Button></a>
